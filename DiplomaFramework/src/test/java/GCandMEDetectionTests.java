...
public class GCandMEDetectionTests extends BaseTest{
    private static final Logger log = Logger.getLogger(GCandMEDetectionTests.class);
    ...
    public void detectXBIonAllPagesFireFox() throws IOException, JSONException {
        ...
        String testingScreenshotName = report.getNumber()+"_ME_testing.png";
        ...
        Comparison comparison = new Comparison("GoogleChrome", "MicrosoftEdge");
        ...
        for(VisualDifference visualDifference : visualDifferences) {
            String nameOfFile = report.getNumber()+"_ME_drawing.png";
